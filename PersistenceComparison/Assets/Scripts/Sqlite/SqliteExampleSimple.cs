...
public class SqliteExampleSimple : MonoBehaviour
{
    ...
    private void OnMouseDown()
    {
        ...
        dbCommandInsertValue.CommandText = "INSERT OR REPLACE INTO HitCountTableSimple (id, value) VALUES (0, " + hitCount + ")";
    ...
    private IDbConnection CreateAndOpenDatabase()
    {
        ...
        dbCommandCreateTable.CommandText = "CREATE TABLE IF NOT EXISTS HitCountTableSimple (id INTEGER PRIMARY KEY, value INTEGER )";
